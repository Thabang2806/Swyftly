...
def desktop_header(active='Shop'):
    ...
    return f'''<div class="header">
      <div class="logo"><div class="logo-mark">S</div>Mabuntle</div>
...
def mobile_appbar(title='Mabuntle', icon='☰'):
...
def side_nav(active='Dashboard', kind='seller'):
    ...
    return f'''<div class="side-nav"><div class="logo"><div class="logo-mark">S</div>Mabuntle</div>{html}</div>'''
    ...
    <main class="main">
      <section class="hero">
        <div class="hero-copy">
          ...
          <div class="h1">Shop local style, beauty & jewellery. Mabuntle.</div>
...
def desktop_checkout():
    ...
    <main class="main">
      ...
      <div class="grid two" style="margin-top:24px;grid-template-columns:1.1fr .75fr">
        <section class="card pad"><div class="h3">Delivery information</div><div class="form-grid" style="margin-top:14px"><div class="field">First name · Naledi</div><div class="field">Last name · Mokoena</div><div class="field">Phone · +27 82 000 0000</div><div class="field">Email · naledi@mabuntle.co.za</div><div class="field" style="grid-column:span 2">Address · 24 Rose Street, Johannesburg</div></div><div class="divider"></div><div class="h3">Shipping method</div><div class="grid two" style="grid-template-columns:1fr 1fr;margin-top:12px"><div class="summary-box"><div class="row between"><b>Standard courier</b><span>R89</span></div><p class="muted small">2–4 business days</p></div><div class="summary-box" style="border-color:var(--primary)"><div class="row between"><b>Pickup point</b><span>R59</span></div><p class="muted small">Pargo / Pudo options</p></div></div><div class="divider"></div><div class="h3">Payment</div><div class="field" style="margin-top:12px">Paystack secure card checkout · **** **** **** 0424</div><div class="row" style="margin-top:22px"><button class="btn success">Pay R1,527 Securely</button><button class="btn secondary">Back to cart</button></div></section>
...
# Zip package
subprocess.run(['bash','-lc',f'cd {OUT.parent} && zip -qr mabuntle_ui_mockups.zip mabuntle_ui_mockups'], check=True)
