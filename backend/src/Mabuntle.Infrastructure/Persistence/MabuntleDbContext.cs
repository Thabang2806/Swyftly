...
public sealed class MabuntleDbContext(DbContextOptions<MabuntleDbContext> options)
    : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>(options)
{
    ...
    {
        optionsBuilder.ReplaceService<IModelCacheKeyFactory, MabuntleDbContextModelCacheKeyFactory>();
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BuyerAiDiscoveryHistory>(builder =>
        {
            ...
            builder.Property(history => history.Category).HasMaxLength(Mabuntle.Domain.Buyers.BuyerAiDiscoveryHistory.ContextFieldMaxLength);
            builder.Property(history => history.Colour).HasMaxLength(Mabuntle.Domain.Buyers.BuyerAiDiscoveryHistory.ContextFieldMaxLength);
            builder.Property(history => history.Material).HasMaxLength(Mabuntle.Domain.Buyers.BuyerAiDiscoveryHistory.ContextFieldMaxLength);
            ...
            builder.Property(history => history.SourceRoute).HasMaxLength(Mabuntle.Domain.Buyers.BuyerAiDiscoveryHistory.SourceRouteMaxLength);
        ...
        modelBuilder.Entity<SellerVerificationEvidence>(builder =>
        {
            ...
            builder.Property(evidence => evidence.StorageProvider)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.StorageProviderMaxLength)
                .IsRequired();
            builder.Property(evidence => evidence.StorageKey)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.StorageKeyMaxLength)
                .IsRequired();
            builder.Property(evidence => evidence.OriginalFileName)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.OriginalFileNameMaxLength)
                .IsRequired();
            builder.Property(evidence => evidence.ContentType)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.ContentTypeMaxLength)
                .IsRequired();
            builder.Property(evidence => evidence.ByteSize).IsRequired();
            builder.Property(evidence => evidence.Sha256Hash)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.Sha256HashMaxLength)
                .IsRequired();
            builder.Property(evidence => evidence.Note)
                .HasMaxLength(Mabuntle.Domain.Sellers.SellerVerificationEvidence.NoteMaxLength);
