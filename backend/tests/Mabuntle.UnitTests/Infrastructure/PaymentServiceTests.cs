...
public class PaymentServiceTests
{
    ...
    private static EfPaymentService CreateService(MabuntleDbContext dbContext, PaymentProviderOptions paymentOptions)
    {
    ...
    private static async Task<(BuyerProfile Buyer, ProductVariant Variant, Order Order)> SeedOrderWithReservationAsync(MabuntleDbContext dbContext)
    {
