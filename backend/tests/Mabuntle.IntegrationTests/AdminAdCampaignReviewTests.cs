...
public sealed class AdminAdCampaignReviewTests
{
    ...
    public async Task Approve_RechecksProductEligibility()
    {
        ...
        var dbContextAfter = scopeAfter.ServiceProvider.GetRequiredService<MabuntleDbContext>();
    ...
    {
        private readonly string _databaseName = $"MabuntleAdminAdCampaignReviewTests_{Guid.NewGuid():N}";
