...
public sealed class SecurityConfigurationValidatorTests
{
    ...
    public void ValidateProductionConfiguration_RejectsDefaultJwtSigningKey()
    {
        ...
        {
            ["ConnectionStrings:DefaultConnection"] = "Host=db.internal;Port=5432;Database=mabuntle;Username=mabuntle_app;Password=ProdDbValueForTests2026!",
            ...
            ["PayFast:NotifyUrl"] = "https://api.mabuntle.example/api/payments/webhook/payfast",
            ["PayFast:CheckoutBridgeBaseUrl"] = "https://api.mabuntle.example",
    ...
    public void ValidateProductionConfiguration_AllowsStrongExternalValues()
    {
        ...
        {
            ["ConnectionStrings:DefaultConnection"] = "Host=db.internal;Port=5432;Database=mabuntle;Username=mabuntle_app;Password=ProdDbValueForTests2026!",
            ["Jwt:SigningKey"] = "ProdJwtSigningKeyValueForMabuntle2026!!",
            ["PaymentProvider:ProviderName"] = "PayFast",
            ["PayFast:MerchantId"] = "100001",
            ["PayFast:MerchantKey"] = "prod-merchant-key",
            ["PayFast:Passphrase"] = "prod-payfast-passphrase",
            ...
            ["AuthCookies:Domain"] = ".mabuntle.example",
            ["Cors:AllowedOrigins:0"] = "https://mabuntle.example",
            ["EmailDelivery:ProviderName"] = "Smtp",
            ["EmailDelivery:FromAddress"] = "no-reply@mabuntle.example",
            ["EmailDelivery:Smtp:Host"] = "smtp.mabuntle.example",
    ...
    {
        var configuration = BuildValidProductionConfiguration();
        configuration["Cors:AllowedOrigins:0"] = "https://*.mabuntle.example";
