      ...
      @if (isLoading()) {
        ...
        <div class="product-detail-layout hf-product-detail-layout">
              ...
              @if (selectedImage()) {
                ...
                <div class="product-gallery-placeholder">
                  <app-product-visual-fallback
                    [label]="productDetail()?.product?.categoryPath ?? 'Mabuntle product'"
          ...
          <div class="product-detail-info product-purchase-panel">
            ...
            <app-status-badge [label]="productDetail()?.product?.merchandisingLabel ?? productDetail()?.product?.categoryPath ?? 'Mabuntle product'" tone="accent" />
            ...
            <section class="product-reviews-panel">
              <div class="product-section-heading">
                <span>
                  <h2>Buyer reviews</h2>
                  <p>Verified-purchase reviews from delivered Mabuntle orders.</p>
                </span>
                @if (reviewSummary()) {
...
export class ProductDetailPageComponent implements OnInit, OnDestroy {
  ...
  private updateSeoMetadata(detail: PublicProductDetailResponse): void {
    ...
    const description = detail.seoDescription?.trim()
      ...
      || 'View this published Mabuntle marketplace listing.';

    this.titleService.setTitle(`${title} | Mabuntle`);
