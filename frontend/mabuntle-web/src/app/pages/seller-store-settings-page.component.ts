      ...
      @if (isLoading()) {
        ...
        <div class="seller-settings-grid">
          ...
          <section class="route-card wizard-form seller-store-policy-panel">
            ...
            <p>These policies appear on your storefront, product pages, and checkout-time order records. They guide return and support conversations, but Mabuntle still reviews return, dispute, refund, and support workflows separately.</p>
          ...
          <section class="route-card wizard-form seller-notification-preferences">
            ...
            <p>Choose how Mabuntle sends transactional updates about verification, listing reviews, revisions, and ad campaigns.</p>
